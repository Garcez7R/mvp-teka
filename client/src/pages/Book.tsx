  ...
  if (id?.startsWith('demo-')) {
    const demoBooks = [
      ...
      },
      {
        ...
        description: 'Clássico da literatura infantil sobre um pequeno príncipe que viaja por diferentes planetas.',
        pages: 96,
        year: 1943,
        sebo: {
      ...
      },
      {
        ...
        description: 'Uma jornada pela história da humanidade, desde os primeiros hominídeos até os dias atuais.',
        pages: 443,
        year: 2011,
        sebo: {
          name: 'Livraria Releitura',
      ...
      },
      {
        ...
        description: 'História de um pastor que parte em busca de seu tesouro.',
        pages: 192,
        year: 1988,
        sebo: {
          name: 'Sebo do Porto',
