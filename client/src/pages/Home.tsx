...
export default function Home() {
  ...
  const launchConfetti = () => {
    ...
    for (let i = 0; i < 210; i += 1) {
      ...
      piece.className = isCircle ? "teka-confetti-piece is-circle" : "teka-confetti-piece";
      ...
      const leftBias = (Math.random() * 0.6 + 0.2) * 100 * centerBias + Math.random() * 100 * (1 - centerBias);
      piece.style.left = `${leftBias}%`;
      ...
      piece.style.height = isCircle ? `${size}px` : `${size * 1.4}px`;
