...
export const sebos = sqliteTable("sebos", {
  ...
  openingYear: int("openingYear"),
  logoUrl: text("logoUrl"),
  supportsPickup: integer("supportsPickup", { mode: "boolean" }).default(true),
  shipsNeighborhood: integer("shipsNeighborhood", { mode: "boolean" }).default(false),
  shipsCity: integer("shipsCity", { mode: "boolean" }).default(false),
  shipsState: integer("shipsState", { mode: "boolean" }).default(false),
  shipsNationwide: integer("shipsNationwide", { mode: "boolean" }).default(false),
  shippingAreas: text("shippingAreas"),
...
// Avaliações de sebos (comprador -> sebo)
